    ...
    >
      ...
      <div className="flex flex-col items-start ml-2 font-serif text-left">
        ...
        <ul className="py-2 w-60">
          <li className="hover:bg-[#ecce7e]  border-2 border-[#012f2c] rounded-full p-2 cursor-pointer">
            {chatTitle}
          </li>
        </ul>
      </div>
      ...
      <div className="my-4 absolute font-serif bottom-0  w-full">
        <button
          ...
          className="bg-[#cce270] w-56 py-2 mx-4 rounded-md text-xl font-semibold active:bg-[#b1c94d] transition duration-300 ease-in-out hover:border-2 hover:border-[#85973f]"
        >
          Log out
        </button>
      </div>
