...
const ProfilePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.put(`/auth/update/${currentUser._id}`, formData, { withCredentials: true });
      const data = res.data;
          ...
          <div className='flex-1 px-2 flex flex-col gap-4'>
            <form className="" onSubmit={handleSubmit}>
              <div className="flex flex-col gap-3">
                <label htmlFor="username" className="text-sm font-semibold text-[#012f2c]">Username</label>
                <input
                  type="text"
                  id="username"
                  required
              ...
              <div className="flex flex-col gap-3">
                <label htmlFor="email" className="text-sm font-semibold text-[#012f2c]">Email</label>
                <input
                  type="email"
                  id="email"
              ...
              <div className="flex flex-col gap-3">
                <label htmlFor="gender" className="text-sm font-semibold text-[#012f2c]">Gender</label>
                <select
                  id="gender"
              ...
              <div className="flex flex-col gap-3">
                <label htmlFor="age" className="text-sm font-semibold text-[#012f2c]">Age</label>
                <input
                  type="number"
                  id="age"
                  value={formData.age}
